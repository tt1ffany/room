                    ...
                    <div className="relative z-10 pt-8 px-6 md:px-12">
                        <div className="max-w-2xl mx-auto">
                            <div className="mb-2 flex justify-between items-center">
                                ...
                                <span className="text-sm text-[#5B6B52]">{Math.round(progress)}%</span>
                            </div>
                            ...
                            {!hasStarted ? (
                                ...
                                >
                                    <div className="space-y-4">
                                        ...
                                        <p className="text-xl text-[#5B6B52] max-w-xl mx-auto">
                                            Create a personalized 3D room that matches your productivity goals and desired mood
                                        </p>
                                    </div>
                                    <Button
                                ...
                                >
                                    ...
                                    <div className="text-center space-y-3">
                                        ...
                                        <p className="text-lg text-[#5B6B52]">{question.subtitle}</p>
                                    </div>
                                    ...
                                    <div className="flex justify-center">
                                        <div className="bg-white/60 backdrop-blur-md rounded-3xl p-2 shadow-xl border border-[#C8D5BC]/40 inline-flex gap-2">
                                            {question.options.map((option) => {
                                                const isSelected = preferences[question.id as keyof RoomPreferences] === option;
                                                return (
                                                    <button
                                                        key={option}
                                                        onClick={() => handleOptionSelect(option)}
                                                        className={`relative px-10 py-6 rounded-2xl transition-all duration-300 ${isSelected
