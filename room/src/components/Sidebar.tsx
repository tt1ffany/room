...
const themes = {
    ...
    evening: {
        ...
        button: 'bg-gradient-to-r from-orange-500 to-purple-500 hover:from-orange-600 hover:to-purple-600 text-white',
...
export function Sidebar({ isOpen, onClose, timeOfDay, onTimeChange, onShuffle }: SidebarProps) {
    ...
    return (
        <div
            className={`fixed top-0 left-0 h-full w-80 shadow-2xl z-30 transform transition-all duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'
                } ${theme.bg}`}
        >
            <div className="flex flex-col h-full min-h-0">
                ...
                <div className={`flex items-center justify-between p-4 border-b ${theme.border}`}>
                    ...
                    <Button variant="ghost" size="icon" onClick={onClose} className={theme.buttonGhost}>
                        <X className="h-5 w-5" />
                    </Button>
                </div>
                ...
                <div className="p-4">
                    <div className="flex gap-2 justify-center">
                        ...
                        <Button
                            ...
                            className={timeOfDay === 'morning' ? 'bg-amber-500 hover:bg-amber-600 text-white' : theme.buttonGhost}
                        >
                        ...
                        <Button
                            ...
                            className={timeOfDay === 'evening' ? 'bg-gradient-to-r from-orange-500 to-purple-500 text-white' : theme.buttonGhost}
                        >
                        ...
                        <Button
                            ...
                            className={timeOfDay === 'night' ? 'bg-blue-600 hover:bg-blue-700 text-white' : theme.buttonGhost}
                        >
